...
class ModelArguments:
    ...
    tokenizer_name: Optional[str] = field(default="/root/train/incorporation_hf2")
...
class DataTrainingArguments:
    ...
    data_cache_dir: Optional[str] = field(default="/root/train/working/dataset_cache")
...
def main():
    ...
    for name, param in model.named_parameters():
        print('requires_grad属性',name, param.requires_grad)
    print('开始训练')
